//
// Created by kimji on 2022-05-03.
//
...
namespace fnv1a {
    ...
    template <class _Kty>ull fnv1a_hash_bytes(
            const _Kty* const _First, const ull _Count) noexcept { // bitwise hashes the representation of an array
        return _Fnv1a_append_bytes1(
                _FNV_offset_basis1, reinterpret_cast<const unsigned char*>(_First), _Count * sizeof(_Kty));
    }
}
