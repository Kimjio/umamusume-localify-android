...
if [ $ABI = "x86" ]; then
  ...
  if [ -d "/data/data/com.komoe.kmumamusumemc" ]; then
    touch /data/data/com.komoe.kmumamusumemc/armeabi-v7a.so
    mount -o bind "/data/adb/modules/${API}_${MODULE_ID}/lib/armeabi-v7a/lib${MODULE_LIB_NAME}.so" /data/data/com.komoe.kmumamusumemc/armeabi-v7a.so
  fi
  ...
  if [ -d "/data/data/com.komoe.kmumamusumemc" ]; then
    touch /data/data/com.komoe.kmumamusumemc/arm64-v8a.so
    touch /data/data/com.komoe.kmumamusumemc/armeabi-v7a.so
    mount -o bind "/data/adb/modules/${API}_${MODULE_ID}/lib/arm64-v8a/lib${MODULE_LIB_NAME}.so" /data/data/com.komoe.kmumamusumemc/arm64-v8a.so
    mount -o bind "/data/adb/modules/${API}_${MODULE_ID}/lib/armeabi-v7a/lib${MODULE_LIB_NAME}.so" /data/data/com.komoe.kmumamusumemc/armeabi-v7a.so
  fi
fi
